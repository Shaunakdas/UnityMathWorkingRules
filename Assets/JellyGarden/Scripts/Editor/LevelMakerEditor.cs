...
public class LevelMakerEditor : EditorWindow
{
	...
	void GUIRate()
	{
		...
		initscript.RateURLIOS = EditorGUILayout.TextField("URL iOS", initscript.RateURLIOS, new GUILayoutOption[] {//2.1.5  ios rate link
			GUILayout.Width (220),
			GUILayout.MaxWidth (220)
		});
	}
...
//            GooglePlayServices.PlayServicesResolver.MenuResolve();//2.1.2
	...
	void GUIHelp()
	{
		GUILayout.Label("Jelly Garden Match 3 Complete Project + EDITOR v 2.1.5", EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width(400) });
