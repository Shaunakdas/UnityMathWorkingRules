...
namespace TexDrawLib
{
	...
	public class TEXSupTabAligner : TEXDrawSupplementBase
    {
        ...
        static readonly string m_formatLTR = "\\lhold[{0}]{{{1}}}{2}";
        static readonly string m_formatRTL = "{2}\\rhold[{0}]{{{1}}}";
        ...
        string ReplaceLinesLTR (string str) {
            int m = 0, idx = 0;
            while (true)
            {
                idx = str.IndexOf('\t', idx);
        ...
        string ReplaceLinesRTL (string str) {
